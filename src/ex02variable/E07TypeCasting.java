...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		//자동형변환 : 작은 자료형의 데이터를 큰자료형에 대입할 때 자동으로 형변환이 일어난다. 
		byte b1 = 65;
		short s1;
		...
		/*
		아래 코드는 자동형변환이 아니다.
		CPU는 int보다 작은 자료를 연산할때는 int로 간주하여 진행하고 결과도 int로 반환한다.
...
//		char ch1 = b1;
		...
		/*
		명시적 형변환(강제형 변환) : 큰 상자의 자료를 작은 상자의 자료형에 할당해야 할 때 사용한다.
			단, 자료의 손실이 있을 수 있으므로 필요한 경우에만 사용해야한다.
		*/
		//만약 129를 대입하여 byte로 형변환시 -127이 출력된다.
		short s2 = 100;
		byte b2 = (byte)s2;
		...
		*/
		...
		문자로 표현하고 싶다면 char형으로 강제형변환하면된다.
		*/
		char ch3 = 'A', ch4;
		int num4 = 2;
//		ch4 = ch3 + num4;
