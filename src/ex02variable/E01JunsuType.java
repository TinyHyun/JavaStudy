...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		...
		- byte, short타입은 게임 캐릭터의 움직임이나 음원파일 등을 표현할 때 주로 사용된다. 
		*/
		...
		- 하지만 큰 자료형과 작은 자료형을 연산하면 큰 자료형으로 자동 형변환된다. 이유는 데이터의 손실(오차)이 있을 수 있기 때문이다.
		- 단, byte와 short형은 예외적인 상황으로 생각하면 된다. CPU가 int형의 연산에 최적화 되어있기 때문이다. 
		*/
		long long1 = 1000, long2 = 2000;
		//int + long = long타입의 결과 출력
		...
		*/
//		long long3 = 2200000000; => int형의 크기인 약 21억 4천만을 넘어서 에러발생
