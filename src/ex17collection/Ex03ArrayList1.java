...
public class Ex03ArrayList1 {
	...
	public static void main(String[] args) {
		...
		/*
		String인스턴스를 저장할 수 있는 List컬렉션 생성 ArrayList와 나머지 컬렉션들은 데어터를
...
//		Vector<String> list = new Vector<String>();
		...
		객체저장 : add()
				...
				add(인덱스, 인스턴스) : 데이터 저장시 인덱스를 직접 부여한다. 단, 인덱스를 건너뛰면 에러 발생
...
//		list.add(5, "소방챀ㅋ"); => 에러발생
		...
		*/
		...
		방법3: Iterator 사용 
			...
			2. hasNext()로 출력할 인스턴스가 있는지 검산한다.
		...
		*/
		...
		/*
		포함여부확인
		contains(객체): 특정 인스턴스가 저장되어있는지 확인할 때 사용한다. 존재한다면 true를 반환한다.
		*/
		...
		/*
		삭제방법1
		: 인덱스로 삭제 => remove(인덱스) : 인덱스를 통해 삭제를 진행한 후 삭제가 완료되면 해당 인스턴스를 반환한다.
