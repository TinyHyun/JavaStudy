...
/*
do~while 문 : 반드시 한번은 실행해야 할 경우 사용하는 반복문으로 조건검사 없이 무조건 한번은 실행된다.

	형식]
		반복을 위한 변수;
		do{
			실행문;
		}while(조건식); <= 문장의 끝에 ;가 들어간다.
*/
public class E04DoWhile {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		시나리오] E03 예제의 1~10까지 더하는 수열문제를 do~while문으로 변경하여 구현사이오. 
		*/
		//누적합과 반복을 위한 변수
		int sum = 0;
		int i = 1;
		...
		*/
		...
		/*
	 	시나리오] 국어, 영어, 수학 점수를 사용자로부터 입력받은 후 평균을 구해 A~F학점을 판단하여 출력하는 프로그램을 작성하시오.
	 		단, 사용자가 X,x(대소문자 구분없음)를 입력하면 프로그램이 종료되어야 하면 do~while문으로 구현해야 한다.
		*/
