...
/*
while문 : 반복횟수가 명확하지 않을 때 사용하는 반복문으로 반복을 위한 초기값, 조건, 증감식을 따로 작성하는 형식을 가진다.
...
public class E03While {
	...
	public static void main(String[] args) {
		...
		//j가 10이하일때까지만 반복
		while(j<=10) {
			//복합대입연산자를 사용해서 증가하는 j를 sum에 누적해서 더한다.
			sum += j;  // => sum = sum + j;
			//반복의 증가식
			j++;
		}
		...
		*/
		...
		while(dan<=9) {
			...
			System.out.println();
			//단을 하나 증가시킨 후 다시 while문의 조건식으로 간다.
			//dan이 9까지 출력된 후 while문의 조건식을 벗어나면 반복문 탈출
			dan++;
		}
		//while문이 끝나면 출력된다.
		System.out.println("\n====================================\n");
