...
//		}
		...
		//논리 and는 둘다 true일때만 true를 반환한다.
		if(num%2==0 && num>=10) {
			//2가지 조건 모두 만족하므로 해당 문장은 출력된다.
			System.out.printf("%d은 짝수이고 10보다 크거나 같다.%n", num);
		}
		...
		//if(조건식); => ;은 문장의 끝을 나타내므로 조건에 상관없이 중괄호에 있는 문장이 실행된다. <주의필요!!!>
		if(num%2 != 0);
		{
		...
		/*
		조건 검사 후 실핼할 문장이 1개인 경우에는 중괄호를 생략할 수 있다.
