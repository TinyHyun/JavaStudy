...
/*
for문 : while문과 같은 반복문으로 초기값, 조건식, 증감식이 한줄에 있어 반복 횟수가 명확할 때 사용하는 반복문이다.
...
public class E05For {
	...
	public static void main(String[] args) {
		...
		//변수 i가 1부터 5까지 1씩 증가하므로 5번 반복한다.
		for(int i=1 ; i<=5 ; i++) {
...
//		System.out.println("위 for문에서 선언한 변수 j= "+ j);
		...
		/*
		for문의 초기값을 외부(넓은 지역, 여기서는 main지역)에서 선언하면 해당변수는 for문의 안쪽(좁은지역)에서 사용할 수 있다.
		...
		*/
		...
		/*
		결론!
		Java에서는 {중괄호}가 나오면 하나의 지역이라 생각하면 된다. 
