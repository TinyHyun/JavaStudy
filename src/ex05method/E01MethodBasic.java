...
public class E01MethodBasic {
	...
	*/
	public static void main(String[] args) {
		...
		/*
		메서드를 호출할 때 함수의 원형을 그대로 기술하면된다.
		매개변수가 있다면 갯수만큼 포함한다.
		갯수가 다르거나 타입이 틀리면 에러가 발생한다. 
		*/
		int result = simpleFunc(1, 2); // 위에서 매개변수를 int타입으로 선언했으므로 정수만 가능하다.
