...
/*
Method(메서드, 함수) : 객체지향 프로그래밍에서 행동 또는 동작을 의미한다.
...
public class E02MethodType01 {
	...
	static void returnError() {
		...
		/*
		이와 같이 메서드 중간에 return을 기술하면 즉시 종료되므로 그 아래에 있는 코드는 실행되지 않는
		쓰레기코드가 된다. 따라서 return을 사용할 때는 반드시 조건문과 같이 기술되어야 한다.
...
//		return;
		...
		if(returnValue%2==0) {
			...
			return; // 10은 2로 나눴을때 나머지가 0이므로 짝수라 함수 종료
		}
