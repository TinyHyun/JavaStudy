...
public class Teacher extends Person {
	...
	*/
	...
	정수형 멤버변수는 그냥 사용하면되고 객체형 멤버변수는 hashCode()를 통해 정수값으로 반환되는 참조값을 사용하면된다.
	*/
	@Override
	public int hashCode() {
		...
		/*
		방법2: 방법1이 번거롭다면 Object 클래스의 정적메서드인 hash()를 사용해도 된다.
			멤버변수의 객수만큼 인수로 전달하면 위와 동일하게 고유한 조수값을 정수형으로 반환해준다.
		*/
	...
	public boolean equals(Object obj) {
		...
		*/
		if((teacher.getAge() == super.getAge()) && teacher.subject.equals(this.subject)) {
			//모든 내용이 일치하면 true를 반환한다. 그러면 set컬렉션에는 add(추가)되지 않는다.
			return true;
		}
		else {
			//만약 내용이 틀리다면 add된다.
