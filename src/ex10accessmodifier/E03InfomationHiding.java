...
///////////////////////////////////////////////////////////////////////////////////////////////
		...
		멤버변수의 정보은닉을 통해 비정상적인 접근을 차단하고 멤버메서드를 통해서만 구매가 이루어질 수 있도록 구현한다.
		*/
		
		
//		seller1.myMoney += 1000; //판매자1에게 1000원 지불
//		buyer.myMoney -= 1000; //구매자의 금액 차감
//		seller1.numOfApple -= 50; //판매자1에게 사과 50개를 구매한다.
//		buyer.numOfApple += 50; //구매자는 사과 50개가 증가한다.
		
		//정보은닉(Information hiding)을 통해 판매의 규칙이 지켜지게된다.
		//각 판매자에게 1000원을 지불한다.
		buyer.buyApple(seller1, 1000); //단가가 1000원이므로 1개를 구매할 수 있다.
		buyer.buyApple(seller2, 1000); //단가가 500원이므로 2개를 구매할 수 있다.
