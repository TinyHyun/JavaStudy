...
private은 class정의에는 사용할 수 없다. 그래서 아래는 에러가 나온다.
*/
...
/*
해당 클래스는 접근지정자를 생략했으므로 default클래스로 정의된다.
...
public으로 정의하는 경우 다른 패키지에서도 접근을 허용하게되므로 하나의 Java파일에
하나의 class만 정의하는것을 권장한다.
*/
