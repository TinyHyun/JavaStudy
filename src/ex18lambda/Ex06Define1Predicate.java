...
public class Ex06Define1Predicate {
	...
	public static void main(String[] args) {
		...
		매개변수로 Human객체를 전달하고 getter인 getGander()를 통해 성별이 "남"인 경우 true를 반환하도록 정의됨
		*/
		Predicate<Human> pre = (Human h) -> {
			return h.getGender().equals("남");
		};
		
		System.out.println("p.text(p1) => " + pre.test(p1));  //true
		System.out.println("p.text(p2) => " + pre.test(p2));  //false
