...
class Account{
	...
	//멤버변수
	String name;
	String accountNumber; // => 계좌번호는 연산의 대상이 아니므로 String타입으로 선언한다.
	int balance; // => 연산이 일어나므로 int타입으로 선언한다.
	
	//멤버메서드1 : 입금
	void deposit(int money) {
		//매개변수로 전달된 money만큼 잔고에 합산한다.
		balance += money;
