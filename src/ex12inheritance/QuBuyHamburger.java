...
class Burger {
	...
	public void BurgerInfo() {
		...
		System.out.printf("식재료: %s,%s,%s%n", patty, sauce, vege);
	}
}
...
class HamburgerPrice {
	...
	public void basicPrice() {
		...
		System.out.printf("결제금액: %d%n", price);
	}
...
class SetPrice extends HamburgerPrice {	
	...
	@Override
	public void basicPrice() {
		int price = burger.getPrice() + COKE + POTATO - 500;
		System.out.printf("세트결제금액: %d%n", price);
	}
